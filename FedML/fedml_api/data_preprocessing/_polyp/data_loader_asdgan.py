...
def get_transforms_G():
    ...
    transforms_args_test = {
        "CenterCrop": [256],
        "ToTensorScale": ['float', 255, 1], # maxv_lb == 1 because polyp has only 1 class
...
def load_partition_data_distributed_polyp(process_id, dataset, data_dir, partition_method,
